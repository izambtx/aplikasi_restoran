...
<body>
		...
		<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
	      ...
	      <div class="collapse navbar-collapse" id="navbarSupportedContent">
	        <ul class="navbar-nav mr-auto">
	          ...
	          <li class="nav-item">
	            <a class="nav-link ml-3 btn" href="<?php echo e(url('desert')); ?>">Dessert</a>
	          </li>
	          <li class="nav-item">
  ...
  <div class="w3-row-padding w3-padding-16 w3-center" id="food">
    ...
    <div class="w3-quarter">
      ...
      <h3><?php echo e($m->nama_makanan); ?></h3>
      <p>RP <?php echo e($m->harga_makanan); ?></p>
      <p><?php echo e($m->status_makanan); ?></p>
...
<?php /**PATH C:\xampp2\htdocs\aplikasi_restoran\resources\views/makanan.blade.php ENDPATH**/ ?>