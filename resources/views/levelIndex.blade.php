...
<body>
	...
	<div class="float-right mt-2">
        <a class="btn btn-info" href="{{url('levelIndex/tambah')}}" role="button" data-toggle="modal" data-target=#tambahlevel>Tambah Data</a>
    </div>
	<table class=" table table-bordered">
		...
		<tbody>
			@foreach($level as $l)
			<tr>
				<td class="text-center">{{ $l->id_level }}</td>
				<td class="text-center">{{ $l->nama_level }}</td>
				<td>
					<a class="btn btn-warning btn-center" href="{{url('/levelIndex/ubah')}}/{{ $l->id_level }}" role="button">Edit</a>
					|
					<a class="btn btn-danger btn-center" href="{{url('/levelIndex/hapus')}}/{{ $l->id_level }}" role="button">Hapus</a>
				</td>
			</tr>
			@endforeach
		</tbody>
...
<!-- isi modal -->
  ...
  <br><br>
    <form method="POST" role="form" action="{{url('/levelIndex/tambah')}}" enctype="multipart/form-data" >
      {{csrf_field()}}
...
<div id="modalEdit" class="modal fade bd-example-modal-xl">
    <div class="modal-dialog modal-l">
      <div class="modal-content">
        ...
        <div class=" modal-body">
          <form method="post" action="{{url('/levelIndex/ubah/save')}}">
            @csrf
